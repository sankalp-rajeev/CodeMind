...
import { FileSearch, X, Play, Loader2 } from 'lucide-react'
...
export default function ReviewPanel({ onStart, onClose }: ReviewPanelProps) {
                ...
                <div className="px-6 py-4 border-b border-border flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-text-secondary mt-0.5">
                            Parallel analysis by security, performance, test, and docs specialists
                        </p>
                    </div>
                    <button
                        onClick={onClose}
